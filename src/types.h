...
constexpr PieceSet NGUHANH_PIECES = PieceSet((1ULL << CUSTOM_PIECE_1)
                                           | (1ULL << CUSTOM_PIECE_2)
                                           | (1ULL << CUSTOM_PIECE_3)
                                           | (1ULL << CUSTOM_PIECE_4)
                                           | (1ULL << CUSTOM_PIECE_5));

inline bool is_nguhanh_piece(PieceType pt) {
  return pt >= CUSTOM_PIECE_1 && pt <= CUSTOM_PIECE_5;
}

inline PieceType nguhanh_generated_piece(PieceType pt) {
  switch (pt)
  {
  case CUSTOM_PIECE_1: return CUSTOM_PIECE_2; // Kim sinh Thuy
  case CUSTOM_PIECE_2: return CUSTOM_PIECE_3; // Thuy sinh Moc
  case CUSTOM_PIECE_3: return CUSTOM_PIECE_4; // Moc sinh Hoa
  case CUSTOM_PIECE_4: return CUSTOM_PIECE_5; // Hoa sinh Tho
  case CUSTOM_PIECE_5: return CUSTOM_PIECE_1; // Tho sinh Kim
  default:             return NO_PIECE_TYPE;
  }
}

inline bool nguhanh_piece_can_capture(PieceType attacker, PieceType victim) {
  if (victim == NO_PIECE_TYPE || victim == KING)
      return false;
  if (attacker == KING)
      return true;
  ...
  switch (attacker)
  {
  case CUSTOM_PIECE_1: return victim == CUSTOM_PIECE_3; // Kim an Moc
  case CUSTOM_PIECE_2: return victim == CUSTOM_PIECE_4; // Thuy an Hoa
  case CUSTOM_PIECE_3: return victim == CUSTOM_PIECE_5; // Moc an Tho
  case CUSTOM_PIECE_4: return victim == CUSTOM_PIECE_1; // Hoa an Kim
  case CUSTOM_PIECE_5: return victim == CUSTOM_PIECE_2; // Tho an Thuy
